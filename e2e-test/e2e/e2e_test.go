...
import (
	...
	_ "github.com/AliyunContainerService/kubernetes-cronhpa-controller/e2e-test"
	e2econfig "github.com/AliyunContainerService/kubernetes-cronhpa-controller/e2e-test/e2e/config" // test sources
)
...
func RunE2ETests(t *testing.T) {
	...
	ginkgo.RunSpecsWithDefaultAndCustomReporters(t, "cronhpa e2e suit", r)
}
...
func hackRegisterClusterFlags(flags *flag.FlagSet) {
	...
	if len(framework.TestContext.KubeConfig) < 1 {
		framework.TestContext.KubeConfig = "/root/.kube/config"
	}
